...
<header class="header bg-light dker bg-gradient">
  <p>DAFTAR BARANG PERLENGKAPAN</p>
</header>
...
<div class="doc-buttons">
	<div class="content table-responsive table-full-width">
		<table class="table table-striped m-b-none" style="width:100%">
			<thead>
				<form method="POST" action="<?php echo base_url().'index.php/welcome/search_barang_perlengkapan/';?>">
			...
			<tbody>
				<?php
					...
					foreach($data as $d){
						...
						$id = $d['id'];
				?>
				<form method="POST" action="<?php echo base_url().'index.php/welcome/ubah_barang_perlengkapan/'.$d['id'] ?>">
				<tr>
					<td><?php echo $x++; ?></td>
				...
				<?php } ?>
				<tr>
					<form method="POST" action="<?php echo base_url().'index.php/welcome/tambah_barang_perlengkapan/'; ?>">	
					<td><h6>Add</h6></td>				
