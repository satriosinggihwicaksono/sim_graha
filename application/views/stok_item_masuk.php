...
<div class="doc-buttons">
	<div class="content table-responsive table-full-width">
		...
		<div class="doc-buttons">
	<a data-toggle="modal" data-target="#modal-tbhitemmasuk" data-popup="tooltip" data-placement="top" title="Tambah Order"><li class="btn btn-default fa fa-plus" style="color:red"> Tambah Item Masuk</a>
</div>	
		...
		<table class="table table-striped m-b-none" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a data-toggle="modal" data-target="#modal-ubah_stok_masuk<?=$d['id'];?>" data-popup="tooltip" class="btn btn-info btn-circle" data-placement="top" title="Edit Data"><i class="fa fa-wrench"></i> Ubah</a>
						<a href="<?php echo base_url().'index.php/welcome/tambah_item_masuk/'.$d['id'];?>" class="btn btn-success"> Item Masuk</a>		
