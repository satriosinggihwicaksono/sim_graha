				...
				<div class="bsc-tbl">
					<table class="table table-sc-ex">
						<thead style='background-color:#FFFFFFF'>
							<form method="POST" action="<?php echo base_url().'index.php/stok/search_stok_keluar/'; ?>">
							<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center">
									<a href='<?php echo base_url().'index.php/stok/detail_stok_keluar/'.$d['id']; ?>'><span class="btn btn-success"> Detail</span></a>
								</td>
								<td style="text-align:center">
									<button type="button" class="btn btn-info" data-toggle="modal" data-target="#ubah_stok_keluar<?php echo $d['id']; ?>">Ubah</button>	
									<a href='<?php echo base_url().'index.php/stok/stok_keluar/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
...
<div class="modal fade" id="tbhstokkeluar" role="dialog">
	<div class="modal-dialog modal-large">
		<div class="modal-content">
			...
			<form method="POST" action="<?php echo base_url().'index.php/stok/tambah_stok_keluar' ?>">
