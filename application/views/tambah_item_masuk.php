...
<div class="doc-buttons">
	...
	<div class="col-sm-5">
		...
		<form method="POST" action="<?php echo base_url().'index.php/welcome/search_item_masuk/'; ?>">
		<div class="input-group">
			<input type="hidden" name="id_item_masuk" value="<?php echo $this->uri->segment(3); ?>">		
	...
	<a data-toggle="modal" data-target="#modal-ubah_stok_masuk<?=$this->uri->segment(3);?>" data-popup="tooltip" class="btn btn-success btn-circle" data-placement="top" title="Edit Data"><i class="fa fa-wrench"></i> Ubah</a>	
	</div>	
</div>	
...
<div class="content table-responsive table-full-width">
	<table class="table table-striped m-b-none" style="width:100%">	
		...
		<tbody>
			...
			?>
			<form method="POST" action="<?php echo base_url().'index.php/welcome/ubah_sub_stok_masuk/'.$d['id'] ?>">
			<tr>
				<td><?php echo $x++; ?></td>
