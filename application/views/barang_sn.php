	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="normal-table-list">
			<div class="basic-tb-hd">
				...
				<div class="row">
					<div class="form-group">
						...
						<form method="POST" action="<?php echo base_url().'index.php/persedian_page/search_barang_sn/'; ?>">
							<tr>
			...
			<div class="row">
				...
				<div class="col-md-2">
					<h2><a href="<?php echo base_url().'index.php/printer/printSN/'.$url;?>" onclick="window.open('<?php echo base_url().'index.php/printer/printSN/'.$url; ?>', 'newwindow', 'width=600, height=700'); return false;"><button onclick="demo.showNotification('top','left')" class="fa fa-print"> CETAK</button></a></h2>
				</div>
			</div>	
		</div>
	</div>
