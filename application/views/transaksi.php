				...
				<div class="bsc-tbl">
					<table class="table table-sc-ex">
						<thead style='background-color:#FFFFFFF'>
							<form method="POST" action="<?php echo base_url().'index.php/transaksi/search_transaksi/'; ?>">
							<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center">
									<a href='<?php echo base_url().'index.php/transaksi/detail_transaksi/'.$d['id']; ?>'><span class="btn btn-success"> Detail</span></a>
								</td>
								<td style="text-align:center">
									<button type="button" class="btn btn-info" data-toggle="modal" data-target="#ubhtransaksi<?php echo $d['id']; ?>">Ubah</button>	
									<a href='<?php echo base_url().'index.php/transaksi/delete_transaksi/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
	...
	<div class="text-center">
		<?php
			...
			if($posisi > 0){
				...
				$href = base_url().'index.php/transaksi/'.$this->uri->segment(2).'/'.$link.'/'.$page;
			} else {
...
<div class="modal fade" id="tbhtransaksi" role="dialog">
	<div class="modal-dialog modal-large">
		<div class="modal-content">
			...
			<form method="POST" action="<?php echo base_url().'index.php/transaksi/tambah_transaksi' ?>">
