				...
				<div class="bsc-tbl">
					<table class="table table-sc-ex">
						<thead style='background-color:#FFFFFFF'>
							<form method="POST" action="<?php echo base_url().'index.php/stok/search_pembelian_stok/'; ?>">
							<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center">
									<a href='<?php echo base_url().'index.php/stok/detail_pembelian_stok/'.$d['id']; ?>'><span class="btn btn-success"> Detail</span></a>
								</td>
								<td style="text-align:center">
									<button type="button" class="btn btn-info" data-toggle="modal" data-target="#ubhpembelian_stok<?php echo $d['id']; ?>">Ubah</button>	
									<a href='<?php echo base_url().'index.php/stok/delete_pembelian/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
