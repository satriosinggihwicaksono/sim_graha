		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="normal-table-list">
				<div class="basic-tb-hd">
					...
					<div class="row">
						<div class="col-md-4">
							<form method="POST" action="<?php echo base_url().'index.php/persedian_page/search_pencarian_sn/' ?>">
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center; width:100px;">
									<a href="<?php echo base_url().'index.php/persedian_page/pencarian_sn/^'.$s['id'].'^';?>">
					...
					<table class="table table-sc-ex">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo '<a href="'.base_url().'index.php/stok/detail_pembelian_stok/'.$item_serial[0]['id'].'">'.$item_serial[0]['nota'].'</a>';?></td>
							...
							<tr>
								...
								<td><?php echo $this->komputer->namaCabang($ts['id_from']).' <a href="'.base_url().'index.php/stok/tambah_stok/'.$ts["id_item"].'^'.$ts['id_user'].'^^"><button class="btn btn-'.$color.' '.$color.'-icon-notika"><i class="notika-icon notika-right-arrow"></i></button></a> '.$this->komputer->namacabang($ts['id_to']);?></td>
							...
							<tr>
								...
								<td><?php echo '<a href="'.base_url().'index.php/transaksi/detail_transaksi/'.$transaksi[0]['id'].'">'.$transaksi[0]['nota'].'</a>'; ?></td>
							...
							<tr>
								...
								<td><?php echo '<a href="'.base_url().'index.php/stok/detail_stok_keluar/'.$stok_keluar[0]['id'].'">'.$stok_keluar[0]['nota'].'</a>'; ?></td>
							...
							<tr>
								...
								<td><?php echo '<a href="'.base_url().'index.php/service/detail_service/'.$service[0]['id_service'].'">'.$service[0]['nota'].'</a>'; ?></td>
							...
							<tr>
								...
								<td><?php echo '<a href="'.base_url().'index.php/stok/daftar_return_stok/'.$return[0]['id'].'^">'.$return[0]['nota'].'</a>'; ?></td>
