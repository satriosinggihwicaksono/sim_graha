...
<div class="doc-buttons">
	<div class="content table-responsive table-full-width">
		...
		<div class="doc-buttons">
	<a data-toggle="modal" data-target="#modal-tbhmutasi" data-popup="tooltip" data-placement="top" title="Tambah Order"><li class="btn btn-default fa fa-plus" style="color:red"> Tambah Mutasi</a>
</div>	
	
<div class="content table-responsive table-full-width">
	<table class="table table-striped m-b-none" style="width:100%">
		<thead>
			<form method="POST" action="<?php echo base_url().'index.php/welcome/search_stok_item_masuk' ?>">
			<th>Cabang : 
			<?php if($check_admin) { ?>	
			<select name="cabang">
		...
		<table class="table table-striped m-b-none" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $this->mymodel->namaCabang($d['id_from']); ?></td>
					<td><?php echo $this->mymodel->namaCabang($d['id_to']); ?></td>
					<td><?php echo $d['deskripsi']; ?></td>
					<td>
						<a data-toggle="modal" data-target="#modal-ubahmutasi<?=$d['id'];?>" data-popup="tooltip" class="btn btn-info btn-circle" data-placement="top" title="Edit Data"><i class="fa fa-wrench"></i> Ubah</a>
						<a href="<?php echo base_url().'index.php/welcome/tambah_item_mutasi/'.$d['id'];?>" class="btn btn-success"> Item Masuk</a>		
						<a href="<?php echo base_url().'index.php/welcome/deleteItemMutasi/mutasi/'.$d['id'];?>" onclick="return confirm('Are you sure delete this item?');" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
					</td>
				</tr>			
				<?php } ?>
			</tbody>
