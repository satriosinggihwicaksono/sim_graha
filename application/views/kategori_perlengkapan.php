...
<header class="header bg-light dker bg-gradient">
  <p>KATEGORI PERLENGKAPAN</p>
</header>
<section class="scrollable wrapper">
<div class="doc-buttons">
	<h4>Pencarian</h4>
	<form method="POST" action="<?php echo base_url().'index.php/welcome/search_kategori_perlengkapan' ?>">
	<div class="row">
		<div class="col-md-12">
	...
	<button type="submit" class="btn btn-info btn-fill btn-wd">Tambah Kategori Perlengkapan</button>
	</form>
