				...
				<div class="row">
					<div class="col-md-9">
						<div class="form-group">
							...
							<?php } ?> 
							<hr>
							<form method="POST" action="<?php echo base_url().'index.php/service/search_detail_service/'; ?>">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<a href='<?php echo base_url().'index.php/service/delete_service/'.$service[0]['id'].'/'.$this->uri->segment(2); ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Batalkan</span></a>
						</div>
					</div>
				</div>
			</div>
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align:center; width:100px;">
								<a href="<?php echo base_url().'index.php/service/add_sub_service/'.$service[0]["id"].'/'.$item[0]["id"].'/'.$s["id"].'/'.$harga_jual;?>">
						...
						?>
							...
							<td style="text-align:center; width:100px;">
								<a href="<?php echo base_url().'index.php/service/add_sub_service/'.$service[0]["id"].'/'.$i["id"].'/0/'.$harga_jual;?>">
								<span class="btn btn-success"> Tambah</span></a>
							</td>
						</tr>
						<?php	
				...
				<div class="bsc-tbl">
					<table class="table table-sc-ex">
						...
						<tbody>
							...
							?>
							<form method="POST" action="<?php echo base_url().'index.php/service/ubah_sub_service/'.$d['id']; ?>">
							<tr>
								<td><?php echo $x++; ?></td>
								<td>
									<?php if($d['id_item'] == 0){
								...
								<td style="text-align:center;">
									...
									<?php if($d['id_item'] == 0){ ?>
									<a href='<?php echo base_url().'index.php/persedian_page/delete_item/sub_service/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
									<?php } elseif(empty($serial)) { ?>
									<a href='<?php echo base_url().'index.php/persedian_page/delete_item/sub_service/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
									<?php } else { ?>
									<a href='<?php echo base_url().'index.php/service/delete_sub_service/'.$d['id'].'/'.$serial[0]['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
									<?php } ?>
								</td>
							</tr>	
							</form>	
				...
				<div class="rc-it-ltd">
					<div class="recent-items-ctn">
						<div class="text-align:center;">
							<h2><a href="<?php echo base_url().'index.php/service/service_selesai/'.$service[0]['id'].'/'.array_sum($total_service);?>"><button>SERVICE SELESAI</button></a></h2>
							<h2><a href="<?php echo base_url().'index.php/printer/printService/'.$service[0]['id'];?>" onclick="window.open('<?php echo base_url().'index.php/printer/printService/'.$service[0]['id'];?>', 'newwindow', 'width=600, height=700'); return false;"><button onclick="demo.showNotification('top','left')" class="fa fa-print"> CETAK</button></a></h2>
						</div>
					</div>
				</div>
			</div>
...
<div class="modal fade" id="tbh_service" role="dialog">
	<div class="modal-dialog modal-large">
		<div class="modal-content">
			...
			<form method="POST" action="<?php echo base_url().'index.php/service/add_service/'.$service[0]['id']; ?>">
