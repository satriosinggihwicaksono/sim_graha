...
<div class="doc-buttons">
	<div class="content table-responsive table-full-width">
		<table class="table table-striped m-b-none" style="width:100%">
			<thead>
				<form method="POST" action="<?php echo base_url().'index.php/welcome/search_peralatan/';?>">
			...
			<tbody>
				<?php
					...
					foreach($data as $d){
						...
						$harga_item = $this->db->get('harga_perlengkapan')->result_array();
						if($harga_item){
							$total = $harga_item[0]['unit'] * $harga_item[0]['harga'];
						}	
				?>
				<form method="POST" action="<?php echo base_url().'index.php/welcome/harga_perlengkapan/'.$d['id'] ?>">
				<tr>
					<td><?php echo $x++; ?></td>
