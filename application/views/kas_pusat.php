				...
				<div class="bsc-tbl">
					<table class="table table-sc-ex">
						<thead style='background-color:#FFFFFFF'>
							<form method="POST" action="<?php echo base_url().'index.php/kas/search_kas_pusat/'; ?>">
							<tr>
								<th>Tempat Kas :
					...
					<table class="table table-sc-ex">
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center; width:40px; background-color:<?php echo $warna; ?>;">
									<a href='<?php echo base_url().'index.php/persedian_page/delete_item/kas/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
								</td>
							</tr>
							<?php } ?>
							<tr>
...
<div class="modal fade" id="tbhkas" role="dialog">
	<div class="modal-dialog modal-large">
		<div class="modal-content">
			...
			<form method="POST" action="<?php echo base_url().'index.php/kas/tambah_kas_pusat' ?>">
