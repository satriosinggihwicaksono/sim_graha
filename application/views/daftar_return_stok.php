	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="normal-table-list">
				...
				<?php if($check_admin){ ?>	
				<form method="POST" action="<?php echo base_url().'index.php/stok/search_return_item/'; ?>">
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center; width:100px;">
									<a href="<?php echo base_url().'index.php/stok/add_return_item_list/'.$return[0]['id'].'/'.$item[0]["id"].'/'.$id_serial.'/1'?>">	<span class="btn btn-success"> Tambah</span></a>
								</td>
							</tr>
							<?php 
							} 
							...
							?>
								...
								<td style="text-align:center; width:100px;">
									<?php if($i['serial'] == 0 ){ ?>
									<a href="<?php echo base_url().'index.php/stok/add_return_item_list/'.$return[0]['id'].'/'.$i["id"].'/0/1'?>">	<span class="btn btn-success"> Tambah</span></a>
								<?php } ?>
								</td>
							</tr>
							<?php	
						...
						<tbody>
							...
							<tr>
								...
								<?php if($item[0]['serial'] == 1){ ?>
									<form method="POST" action="<?php echo base_url().'index.php/stok/tambah_tukar_serial_return/'.$d['id']; ?>">
								...
								<td style="text-align:center; width:50px;">
									...
									<form method="POST" action="<?php echo base_url().'index.php/stok/ubah_unit_return_stok/'.$d['id']; ?>">
								...
								<?php if($check_admin ){ ?>
								<td style="text-align:center; width:100px;">	
									<a href='<?php echo base_url().'index.php/persedian_page/delete_barang/return_item/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
								</td>
								<?php } ?>
							</tr>
							<?php } ?>
