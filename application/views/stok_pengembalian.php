			...
			<div class="bsc-tbl">
				<table class="table table-sc-ex">
					<thead style='background-color:#FFFFFFF'>
						<form method="POST" action="<?php echo base_url().'index.php/stok/search_stok_pengembalian/'; ?>">
						<tr>
			...
			<div class="bsc-tbl">
				<table class="table table-sc-ex">
					...
					<tr>
						...
						<td><a href="<?php echo base_url().'index.php/stok/proses_stok_pengembalian/'.$d['id']; ?>" onclick="return confirm('Are you sure delete this item?');"><button class="btn btn-success">Kembalikan</button></a></td>	
					</tr>
					<?php
							}
						?>	
