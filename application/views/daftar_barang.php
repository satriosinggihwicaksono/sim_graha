	...
	<div class="content table-responsive table-full-width">
		<table class="table table-striped m-b-none" style="width:100%">
			<thead>
				...
				?>
				<form method="POST" action="<?php echo base_url().'index.php/welcome/search_barang/';?>">
			...
			<tbody>
				...
				<tr>
					...
					<select name="kategori" value="">
						...
						$categories = $this->db->get('kategori_item')->result_array();
						foreach($categories as $c){ ?>
						<option <?php if($d['kategori'] == $c['kategori']) { ?> selected="selected" <?php } ?> value='<?php echo $c['kategori']; ?>'><?php echo $c['kategori']; ?></option>
						<?php } ?>
					</select></td>
					<td>
					...
					<td><input type="text" name="merek" value="<?php echo $d['merek']; ?>" onkeypress="return isNumberKey(event)" style="width:130px"/></td>
					<td>
						<input type="text" name="tipe" value="<?php echo $d['tipe']; ?>" onkeypress="return isNumberKey(event)" style="width:130px"/>
					...
					<td><input type="text" class="form-control border-input" name="satuan" value="<?php echo $d['satuan']; ?>" style="width:70px"/></td>
					<td>
				...
				<tr>
					...
					<td><input type="text" class="form-control border-input" name="merek" value="" style="width:130px"/></td>	
					<td><input type="text" class="form-control border-input" name="tipe" value="" style="width:130px"/></td>
					<td><input type="text" class="form-control border-input" name="satuan" value="" style="width:70px"/></td>	
