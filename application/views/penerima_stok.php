			...
			<div class="bsc-tbl">
				<table class="table table-sc-ex">
					<thead style='background-color:#FFFFFFF'>
						<form method="POST" action="<?php echo base_url().'index.php/stok/search_penerima_stok/'; ?>">
						<tr>
							<th>Seles :
				...
				<table class="table table-sc-ex">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<?php if($d['status'] == 0){ ?>
									<a href='<?php echo base_url().'index.php/stok/terima_stok/'.$d['id'].'/'.$id_username.'/'.$d['id_to']; ?>'><span class="btn btn-info">Terima</span></a>
								<?php } ?>
