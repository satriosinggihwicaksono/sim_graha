...
<div class="modal fade" id="tbh_kongsi<?php echo $i['id']; ?>" role="dialog">
	<div class="modal-dialog modal-large">
		<div class="modal-content">
			...
			<form method="POST" action="<?php echo base_url().'index.php/stok/tambah_stok_kongsi/'?>">
			<div class="modal-body">
				...
				<div class="row">
					...
					<input type="text" name="keterangan" placeholder="" value="<?php if(!empty($deskripsi)) echo $deskripsi[1]; ?>" >
				</div>
				<hr>
				...
				<div class="row">
					...
					<input type="hidden" name="cabang" placeholder="" value="<?php echo $transaksi[0]['cabang']; ?>">
				</div>
			</div>
			<hr>
