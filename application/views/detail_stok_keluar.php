<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="normal-table-list">
			...
			<?php if($check_admin){ ?>	
			<form method="POST" action="<?php echo base_url().'index.php/stok/search_detail_stok_keluar/'; ?>">
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align:center; width:100px;">
								<a href="<?php echo base_url().'index.php/stok/add_stok_keluar_list/'.$stok_keluar[0]['id'].'/'.$item[0]["id"].'/'.$id_serial.'/1'?>">	<span class="btn btn-success"> Tambah</span></a>
							</td>
						</tr>
						<?php 
						} 
						...
						?>
							...
							<td style="text-align:center; width:100px;">
								<?php if($i['serial'] == 0 ){ ?>
								<a href="<?php echo base_url().'index.php/stok/add_stok_keluar_list/'.$stok_keluar[0]['id'].'/'.$i["id"].'/0/1'?>">	<span class="btn btn-success"> Tambah</span></a>
							<?php } ?>
							</td>
						</tr>
						<?php	
			...
			<div class="bsc-tbl">
				<table class="table table-sc-ex">
					...
					<tbody>
						...
						<tr>
							...
							<?php if(empty($serial)){ ?>
								<form method="POST" action="<?php echo base_url().'index.php/stok/edit_sub_stok_keluar/'.$d['id']; ?>">
							...
							<td style="text-align:center; width:100px;">
								<?php if($item[0]['serial'] == 0){ ?>
									<a href='<?php echo base_url().'index.php/persedian_page/delete_barang/sub_stok_keluar/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
								<?php } else { ?>
									<a href='<?php echo base_url().'index.php/stok/delete_sub_stok_keluar/'.$d['id'].'/'.$serial[0]['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
								<?php } ?>
							</td>
							<?php } ?>
						</tr>
				...
				<div class="row">
					...
					<div class="col-md-3" style="text-align:right">
						<a href="<?php echo base_url().'index.php/stok/simpan_stok_keluar/'.$stok_keluar[0]['id']; ?>"><h1><button>STOK KELUAR</button></h1></a>
					</div>
				</div>
			</div>
		</div>
