...
<div class="doc-buttons">
	<a href ="<?php echo base_url().'index.php/welcome/tambah_pengguna/'; ?>"><button class="btn btn-info btn-fill btn-wd">Tambah Pengguna</button></a>
			...
			<tbody>
				...
				<tr>
					...
					<select name="cabang">
							...
							foreach($user as $c){ 
							?>
						<option <?php if($c['id'] == $d['cabang']) { ?> selected="selected" <?php } ?>  value='<?php echo $c['id']; ?>'><?php echo $c['username']; ?></option>
						<?php } ?>
					</select>
					</td>
					<td>
