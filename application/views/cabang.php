<div class="container">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="normal-table-list">
				<div class="basic-tb-hd">
					<form method="POST" action="<?php echo base_url().'index.php/auth/tambah_cabang' ?>">
						<div class="row">
							<div class="col-md-12">
					...
					<table class="table table-sc-ex">
						...
						<tbody>
							...
							<tr>
								...
								<form method="POST" action="<?php echo base_url().'index.php/auth/ubah_cabang/'.$k['id'] ?>">
								<td style="width:25%;">
									<div class="nk-int-st">
								...
								<td style="width:25%;">
									...
									<a href='<?php echo base_url().'index.php/persedian_page/delete_item/cabang/'.$k['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
								</td>
								</form>	
							</tr>
							<?php } ?>
	...
	<div class="text-center">
		<?php
			...
			$href = base_url().'index.php/auth/'.$this->uri->segment(2).'/'.$page;
