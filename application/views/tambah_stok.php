				...
				<div class="basic-tb-hd">
						<div class="row">
							...
							<div class="col-md-5">
								<div class="form-group">
									<label>Serial</label>
									<form method="POST" action="<?php echo base_url().'index.php/stok/add_stok/'; ?>">
					...
					<table class="table table-sc-ex">
						...
						<tbody>
							<?php  
								...
								foreach($data as $d){
							?>
							<form method="POST" action="<?php echo base_url().'index.php/stok/ubah_serial/'.$d['id']; ?>" >
							<tr>
								...
								<?php if($check_admin || $check_gudang){ ?>
									...
									<td>
										...
										<a href='<?php echo base_url().'index.php/persedian_page/delete_item/serial/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
									</td>
								<?php } ?>
							</tr>
							</form>	
