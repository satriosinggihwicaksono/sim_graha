				...
				<div class="bsc-tbl">
					<table class="table table-sc-ex">
						<thead style='background-color:#FFFFFFF'>
							<form method="POST" action="<?php echo base_url().'index.php/stok/search_transfer_stok/'; ?>">
							<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href='<?php echo base_url().'index.php/stok/daftar_item_stok/'.$d['id'].'^'; ?>'><span class="btn btn-success"> Detail</span></a>
									<?php if($d['status'] == 0 || $check_admin){ ?>
									<a href='<?php echo base_url().'index.php/persedian_page/delete_item/trans_stok/'.$d['id']; ?>' onclick="return confirm('Are you sure delete this item?');">
...
<div class="modal fade" id="transferstok" role="dialog">
	<div class="modal-dialog modal-large">
		<div class="modal-content">
			...
			<form method="POST" action="<?php echo base_url().'index.php/stok/add_transfer_stok/'; ?>">
